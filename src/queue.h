...
/**
 * @brief Peeks the back of the queue.
 *
 * Returns the user data from the back of the queue but does not remove it.
 * This function may be safely called if the queue is empty, in which case
 * <tt>NULL</tt> is returned.
 *
 * @param[in] queue The queue.
 * @return The user data of the last node, or NULL if the queue is empty.
 */
